...
useEffect(() => {
  ...
  return () => {
    ...
    return (
        <header className="z-10 flex h-[60px] items-center justify-between bg-white px-4  transition-colors dark:bg-slate-900 sticky top-0 border-b-2 border-gray-300">
