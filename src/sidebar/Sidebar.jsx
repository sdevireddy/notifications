...
const moduleLinks = {
    CRM: [
        ...
        { to: "/users", label: "Tasks", icon: <FaTasks  size={20} /> },
        { to: "/users", label: "Invoices", icon: <LiaFileInvoiceSolid size={24} /> },
        { to: "/users", label: "Mettings", icon: <SiGotomeeting  size={20} /> },
        { to: "/users", label: "Sales Order", icon: <UserPlus size={20} /> },
        { to: "/users", label: "Calls", icon: <Phone size={20} /> },
    ],
